...
class App extends Component {
  ...
  sellCar(id) {
    ...
    .then( res => {
      ...
      toast.success("You just sold your car guy!")
    }).catch(() => toast.error('Sorry, nobody wants your car!'))
  }
  ...
  addCar() {
    ...
    toast.success('Added your car for sale!')
  }).catch(() => toast.error('Sorry, this car is not for sale!'))
}
